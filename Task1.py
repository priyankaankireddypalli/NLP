...
for i in range(1,21):
  ip=[]  
  url="https://www.amazon.in/Apple-AirPods-with-Charging-Case/product-reviews/B07Q6153FQ/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews"+str(i)
...
amazonreviews=amazonreviews+ip  # adding the reviews of one page to empty list which in future contains all the reviews
# writng reviews in a text file 
with open("iphone12mini.txt","w",encoding='utf8') as output:
    output.write(str(amazonreviews))
# Joinining all the reviews into single paragraph 
ip_rev_string = " ".join(amazonreviews)
import nltk
...
with open("C:\\Users\\WIN10\\Desktop\\LEARNING\\stop.txt","r") as sw:
    stop_words = sw.read()
stop_words = stop_words.split("\n")
stop_words.extend(["time","device","battery","product","good","day","price","amazon"])
...
# positive words 
with open("C:\\Users\\WIN10\\Desktop\\LEARNING\\positive-words.txt","r") as pos:
...
with open("C:\\Users\\WIN10\\Desktop\\LEARNING\\negative-words.txt", "r") as neg:
