...
for i in range(1, 30):
   ip = []  
   url = "https://www.imdb.com/title/tt5571734/reviews?ref_=tt_ql_3" + str(i)
...
with open("pink.txt","w",encoding='utf8') as output:
    output.write(str(imdbreviews))
# Joinining all the reviews into single paragraph 
ip_rev_string = " ".join(imdbreviews)
import nltk
from nltk.corpus import stopwords
# Removing unwanted symbols incase if exists
ip_rev_string = re.sub("[^A-Za-z" "]+"," ", ip_rev_string).lower()
ip_rev_string = re.sub("[0-9" "]+"," ", ip_rev_string)
# words that contained in pink reviews
...
stop_words.extend(["pink","movie","time","day","price",'film'])
...
customised_words = ['great'] # If you want to remove any particular word form text which does not contribute much in meaning
