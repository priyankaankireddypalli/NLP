...
with open('C:\\Users\\WIN10\\Desktop\\LEARNING\\NLPTopicModelling\\NLP-TM.txt', 'r',encoding="utf8") as file:
    cure_therapeutics = file.read()
cure_therapeutics
len(sent_tokenize(cure_therapeutics))
summarize(cure_therapeutics)
summarize(cure_therapeutics, num_sentences=2)
